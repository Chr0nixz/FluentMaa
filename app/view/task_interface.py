...
class TaskWidget(QWidget):
    ...
    def __initWidget(self):
        ...
        recruitItem = QListWidgetItem(self.tr('Recruit'))
        recruitItem.setIcon(QIcon(resource.getImg('maa_logo.png')))
        recruitItem.setData(0, 'Recruit')
        infrastItem = QListWidgetItem(self.tr('Infrast'))
        infrastItem.setIcon(QIcon(resource.getImg('maa_logo.png')))
        infrastItem.setData(0, 'Infrast')
        self.taskOptions.addItem(startUpItem)
        self.taskOptions.addItem(fightItem)
        self.taskOptions.addItem(recruitItem)
        self.taskOptions.addItem(infrastItem)
